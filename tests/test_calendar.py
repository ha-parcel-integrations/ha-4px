"""Tests for the 4PX deliveries calendar."""
from datetime import datetime, timezone
from unittest.mock import MagicMock

from custom_components.fourpx.calendar import FPXDeliveriesCalendar
...
def _cal(data):
    return FPXDeliveriesCalendar(_coordinator(data), _entry())
...
def test_pickup_sets_location():
    cal = _cal([_parcel("A", planned_from="2099-01-01T10:00:00Z", pickup=True, pickup_point="4PX Shop")])
    assert cal._events()[0].location == "4PX Shop"


def test_naive_planned_from_is_not_used_without_a_confirmed_timezone():
